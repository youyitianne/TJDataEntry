...
public class ResStoreDatabaseServiceImp implements ResStoreDatabaseService{
    public static final Logger LOGGER = LoggerFactory.getLogger(ResStoreDatabaseServiceImp.class);
