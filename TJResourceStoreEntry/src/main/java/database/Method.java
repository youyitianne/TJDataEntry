...
public class Method {
    ...
    public HashMap<SqlConstants, String> loadSqlQueries() {
        ...
        Properties queriesProps = new Properties();
        try {
            queriesInputStream=new FileInputStream("confTJResourceStore/sql.properties");
        ...
        sqlQueries.put(SqlConstants.QINIUFILE_INSERT, queriesProps.getProperty("qiniufile_insert"));
        sqlQueries.put(SqlConstants.QINIUFILE_LIST, queriesProps.getProperty("qiniufile_list"));
        sqlQueries.put(SqlConstants.QINIUFILE_COUNT, queriesProps.getProperty("qiniufile_count"));
        return sqlQueries;
    }
