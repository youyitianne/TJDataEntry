...
public class MissionDatabaseServiceVertxEBProxy implements MissionDatabaseService {
  ...
  public MissionDatabaseServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public MissionDatabaseServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
