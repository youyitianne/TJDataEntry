...
public class Load {
    Logger logger= LoggerFactory.getLogger(Load.class);
    /**
     *
     * @return
     */
    public HashMap<ConfigConstants, String> loadConfQueries() {
        InputStream queriesInputStream=null;
        Properties queriesProps = new Properties();
        try {
            queriesInputStream=new FileInputStream("confTJAccount/conf.properties");
