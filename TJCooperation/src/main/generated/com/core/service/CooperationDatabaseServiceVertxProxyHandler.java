...
public class CooperationDatabaseServiceVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 

  private final Vertx vertx;
  private final CooperationDatabaseService service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public CooperationDatabaseServiceVertxProxyHandler(Vertx vertx, CooperationDatabaseService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public CooperationDatabaseServiceVertxProxyHandler(Vertx vertx, CooperationDatabaseService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public CooperationDatabaseServiceVertxProxyHandler(Vertx vertx, CooperationDatabaseService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
