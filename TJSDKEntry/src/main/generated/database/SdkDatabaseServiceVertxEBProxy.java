...
public class SdkDatabaseServiceVertxEBProxy implements SdkDatabaseService {
  ...
  public SdkDatabaseServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public SdkDatabaseServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
