...
public class RedDatabaseServiceVertxEBProxy implements RedDatabaseService {
  ...
  public RedDatabaseServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public RedDatabaseServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public RedDatabaseService queryWithid(String sqlQuery1, String sqlQuery2, JsonArray jsonArray, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    _json.put("sqlQuery1", sqlQuery1);
    _json.put("sqlQuery2", sqlQuery2);
    _json.put("jsonArray", jsonArray);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "queryWithid");
  ...
  public RedDatabaseService queryWithids(String sqlQuery1, String sqlQuery2, JsonArray jsonArray, Handler<AsyncResult<List<JsonObject>>> resultHandler) {
    ...
    _json.put("jsonArray", jsonArray);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "queryWithids");
    _vertx.eventBus().<JsonArray>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public RedDatabaseService batchWithoutParam(List<String> sqlQuery, Handler<AsyncResult<Void>> resultHandler) {
    ...
    JsonObject _json = new JsonObject();
    _json.put("sqlQuery", new JsonArray(sqlQuery));
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "batchWithoutParam");
    _vertx.eventBus().<Void>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
